  ...
  <div id="addCommand">
    ...
    <a-form :label-col="{ span: 4 }" :wrapper-col="{ span: 19 }">
      ...
      <a-form-item label="指令内容">
        <a-textarea placeholder="指令内容" :auto-size="{ minRows: 5, maxRows: 15 }"/>
      </a-form-item>
      <a-form-item label="指令接收单位">
        ...
        <a-select v-model="unit.unitSelected" placeholder="请选择接收单位" style="width: calc(70% - 5px)">
      ...
      <a-form-item :wrapper-col="{ span: 19, offset: 4 }">
        <a-button type="primary">下达指令</a-button>
